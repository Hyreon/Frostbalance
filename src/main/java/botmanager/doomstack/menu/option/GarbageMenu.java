package botmanager.doomstack.menu.option;
...
public class GarbageMenu extends OptionMenu<Integer> {
    ...
    public GarbageMenu(@NotNull DoomStack bot, @NotNull MessageContext context, @NotNull List<? extends Integer> options) {
        super(bot, context, options);
    }

    public GarbageMenu(@NotNull DoomStack bot, @NotNull MessageContext context, @NotNull List<? extends Integer> options, int page) {
