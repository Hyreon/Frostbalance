...
abstract class ListMenu<T>(bot: DoomStack, context: MessageContext, protected val items: List<T>) : Menu(bot, context) {
    ...
    constructor(bot: DoomStack, context: MessageContext, options: List<T>, page: Int) : this(bot, context, options) {
        this.page = page
    }
