...
public abstract class OptionMenu<T> extends ListMenu<T> {
    ...
    public OptionMenu(@NotNull DoomStack bot, @NotNull MessageContext context, @NotNull List<? extends T> options) {
        super(bot, context, options);
        addOptions();
    }

    public OptionMenu(@NotNull DoomStack bot, @NotNull MessageContext context, @NotNull List<? extends T> options, int page) {
