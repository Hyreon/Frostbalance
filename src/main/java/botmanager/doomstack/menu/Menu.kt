...
import botmanager.doomstack.menu.response.MenuTextHook
...
abstract class Menu(protected var bot: DoomStack, val context : MessageContext) {
    ...
    open fun send(channel: MessageChannel, actor: User) {
        bot.addMenu(this)
        this.actor = actor
        val me = messageEmbed
